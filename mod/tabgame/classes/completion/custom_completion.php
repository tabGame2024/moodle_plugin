...
namespace mod_tabgame\completion;

use core_completion\activity_custom_completion;

/**
 * Activity custom completion subclass for the tabgame.
 *
 * Class for defining mod_tabgame's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given tabgame instance and a user.
 *
 * @package    mod_tabgame
